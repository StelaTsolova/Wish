...
public class UserLoginController {
    ...
    public UserLoginController(UserEntityService userEntityService, AuthenticationManager authenticationManager) {
    ...
    public ResponseEntity<?> login(@RequestBody @Valid UserLoginDto userLoginDto,
        ...
        if (bindingResult.hasErrors() || !this.userEntityService.isExistUser(userLoginDto.getEmail(), userLoginDto.getPassword())) {
